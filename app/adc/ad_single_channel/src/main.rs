...
fn main() -> ! {
    ...
    oled::show_string(&mut scl, &mut sda, 1, 1, "ADValue:");
    oled::show_string(&mut scl, &mut sda, 2, 1, "Volatge:0.00V");
    println!("loop ...");
    ...
    loop {
        ...
        oled::show_num(&mut scl, &mut sda, 1, 9, ad_value as u32, 4);
        // 获取电压整数部分
        oled::show_num(&mut scl, &mut sda, 2, 9, voltege as u32, 1);
        // 获取电压小数部分
        oled::show_num(
            &mut scl,
            &mut sda,
